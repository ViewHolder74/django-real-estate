...
class Property(TimeStampedModel):
    ...
    country = CountryField(
        verbose_name=_("Country"), default="Malawi", blank_label="(select country)"
    )
    ...
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="MZ74 Luwinga"
    )
    ...
    tax = models.DecimalField(
        ...
        decimal_places=2,
        default=0.30,
        help_text="30% property tax charged",
    )
    ...
    views = models.IntegerField(verbose_name=_("Toatl Views"), default=0)
    ...
    def final_property_price(self):
        ...
        taxt_amount = round(tax_percentage * property_price, 2)
        price_after_tax = float(round(property_price * taxt_amount, 2))
