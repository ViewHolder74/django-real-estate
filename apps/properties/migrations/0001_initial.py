    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', django_countries.fields.CountryField(default='MK', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Blantyre', max_length=160, verbose_name='City')),
                ...
                ('taxt', models.DecimalField(decimal_places=2, default=0.3, help_text='30% property tax charged', max_digits=6, verbose_name='Property Tax')),
                ...
                ('views', models.IntegerField(default=0, verbose_name='Toatl Views')),
