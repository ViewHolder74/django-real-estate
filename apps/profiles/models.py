...
class Profile(TimeStampedModel):
    ...
    about_me = models.TextField(verbose_name=_("About me"),  default="say something abbout yourself")
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Blantyre", blank=False, null=False)
