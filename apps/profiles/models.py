...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+265998108842"
    )
    about_me = models.TextField(
        verbose_name=_("About me"), default="say something abbout yourself"
    )
    ...
    country = CountryField(
        verbose_name=_("Country"), default="MW", blank=False, null=False
    )
